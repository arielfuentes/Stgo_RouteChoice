...
Como resultado del procedimiento anteriormente mencionado se obtiene:

- Nueva zonificación, 

- Nueva Matriz de Origen-Destino,  

- El cálculo del porcentaje de viajes intrazonales que fueron recuperados, y

- El cálculo de los nuevos tiempos de acceso y egreso por los nuevos centroides de zonas.

\newpage

# CAPÍTULO 4: APLICACIÓN DEL MODELO Y ANÁLISIS DE RESULTADOS

Como se definió inicialmente, el área  
