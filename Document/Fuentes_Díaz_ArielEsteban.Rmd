...
Para ello, se utilizó la librería sfnetworks en R, la que permite calcular las distancias más cortas en un grafo con datos geográficos, en este caso, el grafo construido sobre la vialidad no fue aplicado en direccionalidad dado que solo nos interesan las caminatas, que para los tiempos se consideró que en promedio es de 48 m/min.
