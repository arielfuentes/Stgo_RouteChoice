...
Para encontrar el óptimo de cluster por zona, se usa el estadístico *gap*, en su implementación se considera como máximo número de clusters la cantidad de paradas por zona menos 1, el número de muestras Monte Carlo en 50 y el número de "comienzos" aleatorios está en 25.
